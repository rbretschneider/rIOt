                  ...
                  <td className="px-2 py-3 pr-4 text-center">
                    {d.docker_available ? (
                      <Link
                        ...
                        className="inline-flex items-center justify-center w-8 h-8 rounded-md border border-gray-700 bg-gray-800 hover:bg-gray-700 hover:border-blue-500/50 text-blue-400 hover:text-blue-300 transition-all cursor-pointer"
                        title="Containers"
                      >
